...
class CarForm<T> extends FormField<String> {
  CarForm({
    Key? key,
    this.onChanged,
    this.controller,
                ...
                Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: AutoCompleteTextField(
                      ...
                      onSelected: (value) {
                        state.didChange.call(value.toString());
...
class _TextFormFieldState extends FormFieldState<String> {
  @override
  CarForm get widget => super.widget as CarForm;

  @override
  void didUpdateWidget(CarForm oldWidget) {
